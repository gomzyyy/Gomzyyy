...
import { faHouse, faBell, faCirclePlus, faFire, faRightFromBracket, faComment } from '@fortawesome/free-solid-svg-icons'
            ...
            <header className="sidebar">
                <div className="side-menu">
                    ...
                    <ul className="sidebar-options">
                        ...
                        <li className="option no-decoration"><FontAwesomeIcon icon={faComment} className="option-icon" />Responses</li>
                        <li className="option no-decoration" onClick={handleCreate}><FontAwesomeIcon icon={faCirclePlus} className="option-icon" />Create</li>
